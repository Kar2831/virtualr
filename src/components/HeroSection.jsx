...
const HeroSection = () => {
  return (
    <div className='flex flex-col items-center mt-6 lg:mt-20'>
        <h1 className="text-4xl sm:text-6xl lg:text-7xl text-center tracking-wide">VirtualR Build Tools <span className='bg-gradient-to-r from bg-orange-500 to-orange-800 text-transparent bg-clip-text'>for Developers</span></h1>
